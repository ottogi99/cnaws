...
class CreateStatusEducationPromotionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('status_education_promotions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('status_education_promotions');
    }
}
