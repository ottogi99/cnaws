        ...
        DB::connection()->getpdo()->exec("
          	...
          	BEGIN
                ...
                p_business_year as business_year,
          			...
          			TRUNCATE(T3.amount * 0.21, 0) + (T3.amount - (TRUNCATE(T3.amount * 0.21, 0) + TRUNCATE(T3.amount * 0.49, 0) + TRUNCATE(T3.amount * 0.20, 0) + TRUNCATE(T3.amount * 0.10, 0))) AS budget_do,
          			TRUNCATE(T3.amount * 0.49, 0) AS budget_sigun,
          			TRUNCATE(T3.amount * 0.20, 0) AS budget_center,
          			TRUNCATE(T3.amount * 0.10, 0) AS budget_unit,
          			...
          			ROUND(TRUNCATE(T3.amount * 0.21, 0) + (T3.amount - (TRUNCATE(T3.amount * 0.21, 0) + TRUNCATE(T3.amount * 0.49, 0) + TRUNCATE(T3.amount * 0.20, 0) + TRUNCATE(T3.amount * 0.10, 0))) - T4.payment_do) AS balance_do,
          			ROUND(TRUNCATE(T3.amount * 0.49, 0) - T4.payment_sigun) AS balance_sigun,
          			ROUND(TRUNCATE(T3.amount * 0.20, 0) - T4.payment_center) AS balance_center,
                ROUND(TRUNCATE(T3.amount * 0.10, 0) - T4.payment_unit) AS balance_unit,
