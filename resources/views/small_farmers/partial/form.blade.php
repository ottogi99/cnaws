...
<div class="input-group input-group-lg" style="padding-bottom:10px;">
  ...
  <input type="text" name="address" id="address" value="{{ old('address', $farmer->address) }}" placeholder="도로명주소를 입력하세요" class="form-control" />
...
<div class="input-group input-group-lg {{ $errors->has('contact') ? 'has-error' : '' }}" style="padding-bottom:10px;">
  ...
  <input type="number" name="contact" id="contact" value="{{ old('contact', $farmer->contact) }}" maxlength="11" placeholder="'-' 없이 숫자만 입력하세요" class="form-control" numberOnly/>
...
<div class="input-group input-group-lg {{ $errors->has('acreage1') ? 'has-error' : '' }}" style="padding-bottom:10px;">
  ...
  <input type="number" step="0.1" name="acreage1" id="acreage1" value="{{ old('acreage1', $farmer->acreage1) }}" placeholder="소수점 1자리 단위까지 입력하세요" class="form-control" numberOnly/>
...
<div class="input-group input-group-lg {{ $errors->has('acreage2') ? 'has-error' : '' }}" style="padding-bottom:10px;">
  ...
  <input type="number" step="0.1" name="acreage2" id="acreage2" value="{{ old('acreage2', $farmer->acreage2) }}" placeholder="소수점 1자리 단위까지 입력하세요" class="form-control" numberOnly/>
...
<div class="input-group input-group-lg {{ $errors->has('acreage3') ? 'has-error' : '' }}" style="padding-bottom:10px;">
  ...
  <input type="number" step="0.1" name="acreage3" id="acreage3" value="{{ old('acreage3', $farmer->acreage3) }}" placeholder="소수점 1자리 단위까지 입력하세요" class="form-control" numberOnly/>
