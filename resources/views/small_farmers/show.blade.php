...
<div class="box col-md-6 task6_in" id="task6_in">
  <div class="box-inner" style="background-color:#ffffff;">
    ...
    <div class="box-content" style="padding-bottom:50px;">
      ...
      <div class="input-group input-group-lg" style="padding-bottom:10px;">
        <span class="input-group-addon" style="width:150px; font-size:13px;">소유경지면적(계)</span>
        <span class="form-control" style="width:550px; border:;">{{ $farmer->sum_acreage }}</span>
      </div>
      <div class="input-group input-group-lg" style="padding-bottom:10px;">
        <span class="input-group-addon" style="width:150px; font-size:13px;">소유경지면적(답작)</span>
        <span class="form-control" style="width:550px; border:;">{{ $farmer->acreage1 }}</span>
      </div>
      <div class="input-group input-group-lg" style="padding-bottom:10px;">
        <span class="input-group-addon" style="width:150px; font-size:13px;">소유경지면적(전작)</span>
        <span class="form-control" style="width:550px; border:;">{{ $farmer->acreage2 }}</span>
      </div>
      <div class="input-group input-group-lg" style="padding-bottom:10px;">
        <span class="input-group-addon" style="width:150px; font-size:13px;">소유경지면적(기타)</span>
        <span class="form-control" style="width:550px; border:;">{{ $farmer->acreage3 }}</span>
      </div>
      <div class="input-group input-group-lg" style="padding-bottom:10px;">
      ...
      <div style="float:right; margin-right:30px;">
        @can('edit-small-farmer', $farmer)
        <a href="{{ route('small_farmers.edit', $farmer->id) }}" class="btn btn-sm btn-primary">수정</a>
        @endcan
        @can('delete-small-farmer', $farmer)
  ...
  <script>
      ...
      $('.button__delete').on('click', function(e) {
          ...
          if (confirm('항목을 삭제합니다.')) {
              $.ajax({
                  type: 'DELETE',
                  url: '/small_farmers/' + farmerId
              }).then(function() {
                  window.location.href = '/small_farmers';
              });
          }
      });
  </script>
