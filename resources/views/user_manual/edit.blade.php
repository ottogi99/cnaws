...
@section('content')
  @php $viewName = 'user_manual.edit'; @endphp
  <div class="box col-md-4">
    <div class="box-inner" style="background-color:#ffffff;">
      ...
      <form class="box-content" action="{{ route('user_manual.update', $manual->id) }}" method="POST" enctype="multipart/form-data" style="padding-bottom:50px;">
        @csrf
        {!! method_field('PUT') !!}
  ...
  <script>
    $('.attachment__delete').on('click', function(e) {
        ...
        if (confirm('첨부파일을 삭제하시겠습니까?')) {
            $.ajax({
                type: 'DELETE',
                url: '/user_manual/' + attachmentId + '/delete_file'
            }).then(function() {
