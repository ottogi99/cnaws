@if ($viewName === 'status_labor_payments.create')
...
<div class="input-group input-group-lg {{ $errors->has('birth') ? 'has-error' : '' }}" style="padding-bottom:10px;">
  ...
  value="{{ old('birth', ($row->birth) ? $row->birth : '') }}">
...
<div class="input-group input-group-lg {{ $errors->has('bank_name') ? 'has-error' : '' }}" style="padding-bottom:10px;">
  ...
  <input type="text" name="bank_name" id="bank_name" value="{{ old('bank_name', $row->bank_name) }}" class="form-control" />
...
<div class="input-group input-group-lg {{ $errors->has('bank_account') ? 'has-error' : '' }}" style="padding-bottom:10px;">
  ...
  <input type="text" name="bank_account" id="bank_account" value="{{ old('bank_account', $row->bank_account) }}" class="form-control" />
