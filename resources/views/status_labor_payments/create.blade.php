...
@section('content')
  @php $viewName = 'status_labor_payments.create'; @endphp
  <div class="box col-md-4">
    <div class="box-inner" style="background-color:#ffffff;">
      <div class="box-header well" data-original-title="" style="background:none; height:70px; line-height:60px; font-size:23px;">
        <span>센터운영비(인건비) 지급현황 등록</span>
      </div>

      <form class="box-content" action="{{ route('status_labor_payments.store') }}" method="POST" style="padding-bottom:50px;">
        @csrf
