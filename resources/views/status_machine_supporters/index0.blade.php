...
@section('content')
  ...
  <table class="table">
    ...
    <tr>
      ...
      <td>
        <a href="{{ route('status_machine_supporters.show',  $row->id) }}" class="btn btn-sm btn-primary">보기</a>
  ...
  <a href="{{ route('status_machine_supporters.create') }}" class="btn btn-sm btn-primary">추가</a>
  @endif
  ...
  <div class="container">
    <div class="bg-light">
      <form action="{{ route('status_machine_supporters.import') }}" method="POST" enctype="multipart/form-data" class="form__article">
        @csrf
