...
@section('content')
  @php $viewName = 'status_machine_supporters.edit'; @endphp
  <div class="box col-md-4">
    <div class="box-inner" style="background-color:#ffffff;">
      <div class="box-header well" data-original-title="" style="background:none; height:70px; line-height:60px; font-size:23px;">
        <span>농기계지원반 지원현황 수정</span>
      </div>
      <form class="box-content" id="form__edit" action="{{ route('status_machine_supporters.update', $row->id) }}" method="POST" style="padding-bottom:50px;">
        @csrf
        {!! method_field('PUT') !!}
