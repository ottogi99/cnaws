...
@section('content')
  @php $viewName = 'status_operating_costs.edit'; @endphp
  <div class="box col-md-4">
    <div class="box-inner" style="background-color:#ffffff;">
      <div class="box-header well" data-original-title="" style="background:none; height:70px; line-height:60px; font-size:23px;">
        <span>센터운영비(운영비) 지급현황 수정</span>
      </div>
      <form class="box-content" id="form__edit" action="{{ route('status_operating_costs.update', $row->id) }}" method="POST" style="padding-bottom:50px;">
        @csrf
        {!! method_field('PUT') !!}
