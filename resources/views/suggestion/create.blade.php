...
@section('content')
  @php $viewName = 'suggestion.create'; @endphp
  <div class="box col-md-4">
    <div class="box-inner" style="background-color:#ffffff;">
      ...
      <form class="box-content" action="{{ route('suggestion.store') }}" method="POST" enctype="multipart/form-data" style="padding-bottom:50px;">
        @csrf
