...
@section('content')
  ...
  @if($schedule->is_allow)
  <a href="{{ route('machine_supporters.create') }}" class="btn btn-sm btn-primary">추가</a>
  @endif
  ...
  <div class="container">
    <div class="bg-light">
      <form action="{{ route('machine_supporters.import') }}" method="POST" enctype="multipart/form-data" class="form__article">
        @csrf
