...
@section('content')
  @php $viewName = 'machine_supporters.create'; @endphp
  <div class="box col-md-4">
    <div class="box-inner" style="background-color:#ffffff;">
      <div class="box-header well" data-original-title="" style="background:none; height:70px; line-height:60px; font-size:23px;">
        <span>농기계지원반 항목 등록</span>
      </div>

      <form class="box-content" action="{{ route('machine_supporters.store') }}" method="POST" style="padding-bottom:50px;">
        @csrf
