  ...
  <div class="box-inner" style="background-color:#ffffff;">
    ...
    <div class="box-content" style="padding-bottom:50px;">
      ...
      <div class="input-group input-group-lg" style="padding-bottom:10px;">
        ...
        <span class="form-control" style="width:550px; border:;">{{ $supporter->machine1 }}</span>
      </div>
      <div class="input-group input-group-lg" style="padding-bottom:10px;">
        <span class="input-group-addon" style="width:150px; font-size:13px;">농기계2</span>
        <span class="form-control" style="width:550px; border:;">{{ $supporter->machine2 }}</span>
      </div>
      <div class="input-group input-group-lg" style="padding-bottom:10px;">
        <span class="input-group-addon" style="width:150px; font-size:13px;">농기계3</span>
        <span class="form-control" style="width:550px; border:;">{{ $supporter->machine3 }}</span>
      </div>
      <div class="input-group input-group-lg" style="padding-bottom:10px;">
        <span class="input-group-addon" style="width:150px; font-size:13px;">농기계4</span>
        <span class="form-control" style="width:550px; border:;">{{ $supporter->machine4 }}</span>
      </div>
      <div class="input-group input-group-lg" style="padding-bottom:10px;">
