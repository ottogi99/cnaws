...
<SCRIPT language="javaScript">
	...
	function open_Page(){
		newWindow=window.open("/apis/popup", "도로명주소 검색", "height=400,width=600,resizable=yes");
	}
...
<FORM name=frm1>
	...
	부모창 Sender : <input type=text name=txtSender size=10><br>
	부모창 Receiver : <input type=text name=txtReceiver id='address' size=10><br>
