...
<form name="form" id="form" method="post">
	...
	<input type="text" name="confmKey" value="devU01TX0FVVEgyMDIwMDgwNDEzNTQwMjExMDAyMjg="/><!-- 요청 변수 설정 (승인키) -->
	<input type="text" name="keyword" value="강서로 7길" onkeydown="enterSearch();"/><!-- 요청 변수 설정 (키워드) -->
