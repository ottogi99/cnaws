  ...
  <div class="box-inner" style="background-color:#ffffff;">
    ...
    <div class="box-content" style="padding-bottom:50px;">
      ...
      <div class="input-group input-group-lg" style="padding-bottom:10px;">
        ...
        <span class="form-control" style="width:550px; border:;">{{ ($row->recipient == 'S') ? '지원단' : '농가' }}</span>
      </div>
      <div class="input-group input-group-lg" style="padding-bottom:10px;">
        <span class="input-group-addon" style="width:150px; font-size:13px;">교통비</span>
        <span class="form-control" style="width:550px; border:;">{{ $row->payment_item1 }}</span>
      </div>
      <div class="input-group input-group-lg" style="padding-bottom:10px;">
        <span class="input-group-addon" style="width:150px; font-size:13px;">간식비</span>
        <span class="form-control" style="width:550px; border:;">{{ $row->payment_item2 }}</span>
      </div>
      <div class="input-group input-group-lg" style="padding-bottom:10px;">
        <span class="input-group-addon" style="width:150px; font-size:13px;">마스크구입비</span>
        <span class="form-control" style="width:550px; border:;">{{ $row->payment_item3 }}</span>
      </div>
      <div class="input-group input-group-lg" style="padding-bottom:10px;">
