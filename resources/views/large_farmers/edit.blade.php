...
@section('content')
    @php $viewName = 'large_farmers.edit'; @endphp
  <div class="box col-md-4">
    <div class="box-inner" style="background-color:#ffffff;">
      <div class="box-header well" data-original-title="" style="background:none; height:70px; line-height:60px; font-size:23px;">
        <span>대규모·전업농 수정</span>
      </div>

      <form class="box-content" action="{{ route('large_farmers.update', $farmer->id) }}" method="POST" style="padding-bottom:50px;">
        @csrf
        {!! method_field('PUT') !!}
