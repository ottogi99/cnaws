  ...
  <div class="box-inner" style="background-color:#ffffff;">
    ...
    <div class="box-content" style="padding-bottom:50px;">
      ...
      <table class="table table-condensed">
        <thead>
          <tr>
            ...
            <th colspan='3'>교육정보</th>
            <th rowspan='2' width="5%">상해보험<br/>가입여부</th>
          ...
          <tr>
            ...
            <th width="5%">대상농협</th>
            <th>성명</th>
            <!-- <th width="3%">연령<br/>(세)</th> -->
            <th width="8%">생년월일(연령)</th>
            <th width="3%">성별</th>
            <th>주소</th>
            <th>연락처</th>
            <th width="6%">교육<br/>참여일1</th>
            <th width="6%">교육<br/>참여일2</th>
            <th width="6%">교육<br/>참여일3</th>
            <!-- <th></th> -->
            <th width="5%">은행명</th>
            <th width="5%">계좌번호</th>
            <th>등록일자</th>
        ...
        <tbody>
          ...
          <tr onclick="location.href='{{ route('manpower_supporters.show', $supporter->id) }}'">
            ...
            <td>{{ $supporter->training_date1 }}</td>
            <td>{{ $supporter->training_date2 }}</td>
            <td>{{ $supporter->training_date3 }}</td>
            <td>{{ ($supporter->has_insurance == 1) ? '가입' : '미가입' }}</td>
            ...
            <td>
              ...
              <button class="btn btn-xs btn-primary button__edit" data-id="{{ $supporter->id }}">수정</button>
      ...
      <div style="float:right;">
        ...
        <a href="{{ route('manpower_supporters.export',
...
<script>
  ...
  $('.button__edit').on('click', function(e) {
    ...
    window.location.href = '/manpower_supporters/' + supporterId + '/edit';
  });
      ...
      if (idsArr.length <= 0)
      {
        alert("삭제할 항목을 선택해 주세요.");
          ...
          if (confirm("정말로 선택된 항목을 삭제하시겠습니까?"))
          {
            ...
            $.ajax({
                url: "{{ route('manpower_supporters.multiple-delete') }}",
                type: 'DELETE',
                data: 'ids=' + strIds,
  ...
  $('.btn-down-example').on('click', function () {
    window.location.href = '/manpower_supporters/example';
  })
