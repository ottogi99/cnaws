...
@section('content')
  @php $viewName = 'manpower_supporters.edit'; @endphp
  <div class="box col-md-4">
    <div class="box-inner" style="background-color:#ffffff;">
      ...
      <form class="box-content" action="{{ route('manpower_supporters.update', $supporter->id) }}" method="POST" style="padding-bottom:50px;">
        @csrf
        {!! method_field('PUT') !!}

        @include('manpower_supporters.partial.form')
        <hr/>
        <div class="pull-left">
