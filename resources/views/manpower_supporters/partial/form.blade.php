...
<div class="input-group input-group-lg {{ $errors->has('training_date1') ? 'has-error' : '' }}" style="padding-bottom:10px;">
  ...
  <input type="text" name="training_date1" id="training_date1" value="{{ old('training_date1', $supporter->training_date1) }}" class="form-control" placeholder="교육참여일을 입력하세요" />
...
<div class="input-group input-group-lg {{ $errors->has('training_date2') ? 'has-error' : '' }}" style="padding-bottom:10px;">
  ...
  <input type="text" name="training_date2" id="training_date2" value="{{ old('training_date2', $supporter->training_date2) }}" class="form-control" placeholder="교육참여일을 입력하세요" />
...
<div class="input-group input-group-lg {{ $errors->has('training_date2') ? 'has-error' : '' }}" style="padding-bottom:10px;">
  ...
  <input type="text" name="training_date3" id="training_date3" value="{{ old('training_date3', $supporter->training_date3) }}" class="form-control" placeholder="교육참여일을 입력하세요" />
...
<div class="input-group input-group-lg {{ $errors->has('bank_account') ? 'has-error' : '' }}" style="padding-bottom:10px;">
  ...
  <input type="text" name="bank_account" id="bank_account" value="{{ old('bank_account', $supporter->bank_account) }}" class="form-control" placeholder="계좌번호를 입력하세요"/>
