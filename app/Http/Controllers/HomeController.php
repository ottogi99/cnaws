...
class HomeController extends Controller
{
    ...
    public function index(Request $request, $slug=null)
    {
      ...
      $rows_manpower = \App\StatusManpowerSupporter::with('sigun')->with('nonghyup')->with('farmer')->with('supporter')
        ...
        $rows_notices = \App\Notice::orderby('created_at', 'desc')->paginate(10);

        $rows_suggestions = \App\Suggestion::orderby('created_at', 'desc')->paginate(10);

        return view('home.index', compact('rows_machine', 'rows_manpower', 'rows_notices', 'rows_suggestions'));
    }
}
