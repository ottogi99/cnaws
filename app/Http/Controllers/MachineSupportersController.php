...
class MachineSupportersController extends Controller
{
    ...
    public function index(Request $request, $slug=null)
    {
        ...
        return view('machine_supporters.index', compact('supporters', 'siguns', 'nonghyups'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($e->getCode() == '23000') {
                ...
                flash()->error('동일한 이름의 농기계지원반이 이미 존재하고 있습니다. 입력 데이터를 확인하여 다시 시도하시기 바랍니다. (중복 항목: '.$duplicated.')');
            } else {
