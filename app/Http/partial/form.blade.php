...
<div class="form-group {{ $errors->has('sigun_code') ? 'has-error' : '' }}">
  ...
  <select name="sigun_code" id="sigun_code" readonly >
...
@else
<div class="form-group {{ $errors->has('sigun_name') ? 'has-error' : '' }}">
    <label for="sigun_name">시군명</label>
    <input
      type="text" name="sigun_name" id="sigun_name" placeholder="사용자(농협) ID" value="{{ ($user->sigun) ? $user->sigun->name : '' }}" class="form-control" readonly}}/>
</div>
<div class="form-group {{ $errors->has('sigun_code') ? 'has-error' : '' }}">
    <input
      type="hidden" name="sigun_code" id="sigun_code" placeholder="사용자(농협) ID" value="{{ ($user->sigun) ? $user->sigun->code : '' }}" class="form-control"
      {{ ($user->sigun_code) ? 'readonly' : '' }}/>
</div>
@endif
...
<div class="form-group {{ $errors->has('user_id') ? 'has-error' : '' }}">
    ...
    <input
      type="text" name="user_id" id="user_id" placeholder="사용자(농협) ID" value="{{ old('user_id', $user->user_id) }}" class="form-control"
      {{ ($user->user_id) ? 'readonly' : '' }}/>
</div>
